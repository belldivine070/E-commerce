...
from .models import Department, Position, CustomUser, RolePermission
...
class UserSignupForm(forms.ModelForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'email', 'first_name', 'last_name', 'mobile', 'is_active', 'is_staff', 'profile_image', 'position', 'department', 'assigned_to']

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        for field in ['username', 'email', 'first_name', 'last_name', 'mobile', 'profile_image', 'is_active', 'is_staff', 'assigned_to']:
...
class UserEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_active', 'is_staff', 'profile_image', 'position', 
...
class RoleForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'permissions': forms.CheckboxSelectMultiple(), # This creates the checkboxes
        }
